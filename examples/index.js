...
function generateAgriCultureButtons(inputData, codeName) {
    ...
    var agriHTML = '<h4>Agriculture Data</h4>' +
        '<input type="text" class="form-control" id="myInput" placeholder="Search for datasets.." title="Type in a layer">';
	agriHTML += '<input type="text" class="form-control" id="amount" placeholder="How many top?" title="Type in a layer">';
    var dataPoint = findDataPointCountry(inputData, codeName,3);
    if(dataPoint != 0) {
        var i = 0;
        agriHTML += '<ul id="myUL">';
